...
export default function ContactPage() {
  ...
  return (
    <>
      <Head>
        <title>Kontak Rainbow ACP - Hubungi Kami untuk Konsultasi Aluminium Composite Panel</title>
        <meta name="description" content="Hubungi Rainbow ACP untuk konsultasi dan informasi produk Aluminium Composite Panel. Tim ahli siap membantu kebutuhan proyek konstruksi Anda." />
        <meta name="keywords" content="Kontak Rainbow ACP, Hubungi Rainbow ACP, Konsultasi ACP, Customer Service Rainbow ACP, Alamat Rainbow ACP" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Kontak Rainbow ACP - Hubungi Kami" />
        <meta property="og:description" content="Tim ahli Rainbow ACP siap membantu konsultasi dan kebutuhan Aluminium Composite Panel Anda." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                {officeInfo.map((info, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-start space-x-4 p-4 rounded-lg hover:bg-gray-50 transition-colors duration-300">
                      <div className={`${info.iconBg} w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 mt-1`}>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-xl p-4 md:p-6 shadow-xl">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-green-600">24/7</div>
                  <div className="text-xs md:text-sm text-gray-600">WhatsApp Support</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed max-w-lg">
                ...
                solusi Rainbow ACP yang tepat untuk proyek Anda. Tidak ada biaya, 
                hanya solusi terbaik!
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                {contactMethods.map((method) => {
                  ...
                  return (
                    <div key={method.id} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <div className="flex items-center space-x-3 mb-3">
                        <div className={`${method.iconBg} w-10 h-10 rounded-lg flex items-center justify-center`}>
                          <IconComponent className={`w-5 h-5 ${method.iconColor}`} />
                        </div>
                        <h4 className="font-bold text-gray-900">{method.title}</h4>
                      </div>
                      <p className="text-sm text-gray-600 mb-2">{method.description}</p>
                      <p className="text-sm font-semibold text-blue-600">{method.contact}</p>
                    </div>
                  );
                })}
              </div>
