...
export default function DistributorPage() {
  ...
  return (
    <>
      <Head>
        <title>Distributor Rainbow ACP - Jaringan Nasional Aluminium Composite Panel Indonesia</title>
        <meta name="description" content="Temukan distributor resmi Rainbow ACP terdekat di seluruh Indonesia. Jaringan distribusi terpercaya untuk kebutuhan Aluminium Composite Panel berkualitas tinggi dengan layanan profesional." />
        <meta name="keywords" content="Distributor Rainbow ACP, ACP Indonesia, Distributor Aluminium Composite Panel, Rainbow ACP Jakarta, Rainbow ACP Surabaya, Rainbow ACP Sidoarjo, Supplier ACP Indonesia, Jaringan Distributor ACP" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Distributor Rainbow ACP - Jaringan Nasional Indonesia" />
        <meta property="og:description" content="Jaringan distributor resmi Rainbow ACP di seluruh Indonesia untuk kebutuhan Aluminium Composite Panel berkualitas tinggi dengan layanan terbaik." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/assets/images/distributor/distributor-hero.webp" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Organization",
            "name": "Rainbow ACP",
            "description": "Distributor Aluminium Composite Panel terpercaya di Indonesia",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-12 md:mb-16">
            ...
            <p className="text-gray-600 text-sm sm:text-lg md:text-xl max-w-2xl">
              Tim profesional kami siap melayani kebutuhan Rainbow ACP Anda di berbagai kota besar Indonesia
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-8 md:mb-12 max-w-2xl mx-auto">
            Bergabunglah dengan jaringan distributor Rainbow ACP dan dapatkan keuntungan 
            dari brand terpercaya dengan dukungan penuh dari tim profesional kami.
          </p>
