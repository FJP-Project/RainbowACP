...
// Menggunakan Inter font untuk performa dan keterbacaan yang lebih baik
const inter = Inter({
  variable: "--font-inter",
  subsets: ["latin"],
  display: "swap",
...
export const metadata: Metadata = {
  ...
  description: "Distributor dan supplier ACP (Aluminium Composite Panel) berkualitas tinggi di Indonesia. Tersedia berbagai merk dan ukuran dengan harga kompetitif. Konsultasi gratis!",
  keywords: [
    "ACP Panel", 
  ...
  metadataBase: new URL('https://www.yourwebsite.com'), // Ganti dengan URL domain Anda
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    description: 'Distributor dan supplier ACP (Aluminium Composite Panel) berkualitas tinggi di Indonesia. Konsultasi gratis!',
  ...
  twitter: {
    ...
    title: 'ACP Panel Indonesia | Aluminium Composite Panel Berkualitas',
    description: 'Distributor dan supplier ACP berkualitas tinggi di Indonesia. Konsultasi gratis!',
    images: ['/twitter-image.jpg'], // Pastikan file ini ada di folder public
  },
  robots: {
    index: true,
    follow: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="id" className="scroll-smooth">
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Distributor dan supplier ACP (Aluminium Composite Panel) berkualitas tinggi di Indonesia",
              "address": {
                "@type": "PostalAddress",
      ...
      <body className={`${inter.variable} font-sans antialiased bg-white text-gray-900 selection:bg-green-100 selection:text-green-900`}>
        <a 
          href="#main-content" 
        ...
        {/* Loading indicator */}
        <div id="loading-bar" className="fixed top-0 left-0 w-full h-1 bg-green-500 transform -translate-x-full transition-transform duration-300 z-50"></div>
        ...
        <div className="fixed bottom-6 right-6 z-50 group cursor-pointer" role="button" tabIndex={0} aria-label="Hubungi kami via WhatsApp">
          <a
            ...
            <div className="absolute right-full mr-3 px-4 py-3 bg-gray-900 text-white text-sm rounded-xl shadow-2xl opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300 whitespace-nowrap pointer-events-none border border-gray-700">
              ...
              <div className="text-xs text-gray-300 mt-1">Tanya produk ACP terbaik</div>
